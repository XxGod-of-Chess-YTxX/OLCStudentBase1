...
remove = input("Would you like to remove any of the entries? (Y or N): ")
if remove.upper() == "Y":
    countryremove = input("Enter a country to remove: ").lower()
    del capital_cities[countryremove]
    print(f"{countryremove} removed")
elif remove.upper() == "N":
    print("k")
else:
    print("Invalid input")
...
add = input("Would you like to add a new entry? (Y or N): ")
if add.upper() == "Y":
    key = input("Enter a country to add: ").lower()
    value = input("Enter the country's capital: ").lower()
