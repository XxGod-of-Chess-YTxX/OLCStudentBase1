...
animals = []
while True:
    p1_animals = input("Player 1, please enter your animal(type quit to quit):") 
    
    if p1_animals.lower() == "quit":
        break

    else:
        animals.append(p1_animals)
p2_guess = str(input("Player 2, please enter your guess:"))
...
animals = []          # list to store Player 1 animals
score = 0             # Player 2 score

# -------------------------
# Player 1 enters animals
# -------------------------
while True:
    animal = input("Player 1 - Enter an animal: ")
    animals.append(animal)

    again = input("Do you want to enter another animal? (y/n): ")
    if again.lower() != "y":
        break

print("All animals have been entered.")
print("Now Player 2 will guess.")
...
# Search list for guess

if guess in animals:
    print("Correct! The animal is in the list.")

    animals.remove(guess)
    score += 1
else:
    print("Sorry, that animal is not in the list.")
...
# -----------------------------------------------------------
# Animal guessing game - Player 1 vs Player 2
...
while True:
    ...
    again = input("Add another animal? (y/n): ")
    if again.lower() != "y":
        break

print("Player 2 will now start guessing!")
...
while len(animals) > 0:
    ...
    if guess in animals:
        print("Correct! That animal is in the list.")
        animals.remove(guess)
        score += 1
        print("Score:", score)
        print("Animals left:", animals, "\n")
...
print("Final Results")
print("Player 2 score:", score)
print("Animals remaining in list:", animals)
